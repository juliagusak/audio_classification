...
def parse():
    ...
    default_epochs = 600
    milistones = get_degault_milistones(default_epochs)
    default_settings['esc50'] = {'EnvNet': {'nEpochs': default_epochs, 'LR': 0.01, 'milestones': milistones}}
    default_settings['esc10'] = {'EnvNet': {'nEpochs': default_epochs, 'LR': 0.01, 'milestones': milistones}}
